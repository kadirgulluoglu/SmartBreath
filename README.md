# SmartBreath
## My first project with flutter. This project is supported by TUBITAK. It will be made compatible with the MVVM architecture in the future.
...
<img src="https://github.com/kadirgulluoglu/SmartBreath/blob/main/assets/screenshots/o3.png" width=20% height=20%>

**Multi-language support to appeal to all users**

<img src="https://github.com/kadirgulluoglu/SmartBreath/blob/main/assets/screenshots/o2.png" width=20% height=20%> <img src="https://github.com/kadirgulluoglu/SmartBreath/blob/main/assets/screenshots/o1.png" width=20% height=20%>

**You can customize the theme**

<img src="https://github.com/kadirgulluoglu/SmartBreath/blob/main/assets/screenshots/giris.png" width=20% height=20%>
...
<img src="https://github.com/kadirgulluoglu/SmartBreath/blob/main/assets/screenshots/r3.png" width=20% height=20%> <img src="https://github.com/kadirgulluoglu/SmartBreath/blob/main/assets/screenshots/r2.png" width=20% height=20%> <img src="https://github.com/kadirgulluoglu/SmartBreath/blob/main/assets/screenshots/r1.png" width=20% height=20%>
